...
public class ActivityTest {
    ...
    public void init() {
        ...
        strategy.setStrategyDesc("draw strategy");
        ...
        strategyDetail_01.setAwardName("one price");
        ...
        strategyDetail_02.setAwardName("two price");
        ...
        strategyDetail_03.setAwardName("three price");
        ...
        strategyDetail_04.setAwardName("four price");
        ...
        strategyDetail_05.setAwardName("five price");
        ...
        award_01.setAwardContent("please call fustack");
